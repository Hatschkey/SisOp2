...
#define USER_RECONNECT_TIMEOUT 2.5 // Time (in seconds) the user waits between a server closing and reconnecting
...
// Packet for front-end updates
#define PAK_NEW_SERVER 13
